...
namespace ReportesWindows {
    ...
    public partial class AlmacenDBDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductosDataTable : global::System.Data.TypedTableBase<ProductosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductosRow AddProductosRow(int Id, string Codigo, string Nombre) {
...
namespace ReportesWindows.AlmacenDBDataSetTableAdapters {
    ...
    public partial class ProductosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Productos] WHERE (([Id] = @Original_Id) AND ((@IsNull_Codigo =" +
                " 1 AND [Codigo] IS NULL) OR ([Codigo] = @Original_Codigo)) AND ((@IsNull_Nombre " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Productos] ([Id], [Codigo], [Nombre]) VALUES (@Id, @Codigo, @N" +
                "ombre);\r\nSELECT Id, Codigo, Nombre FROM Productos WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Productos] SET [Id] = @Id, [Codigo] = @Codigo, [Nombre] = @Nombre WHERE (([Id] = @Original_Id) AND ((@IsNull_Codigo = 1 AND [Codigo] IS NULL) OR ([Codigo] = @Original_Codigo)) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)));
SELECT Id, Codigo, Nombre FROM Productos WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ReportesWindows.Properties.Settings.Default.AlmacenDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Codigo, Nombre FROM dbo.Productos";
        ...
        public virtual int Insert(int Id, string Codigo, string Nombre) {
        ...
        public virtual int Update(int Id, string Codigo, string Nombre, int Original_Id, string Original_Codigo, string Original_Nombre) {
        ...
        public virtual int Update(string Codigo, string Nombre, int Original_Id, string Original_Codigo, string Original_Nombre) {
            return this.Update(Original_Id, Codigo, Nombre, Original_Id, Original_Codigo, Original_Nombre);
        }
    }
